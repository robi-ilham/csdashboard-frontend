    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('report.cpro.request.chatbot') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label" for="division">Content</label>
...
<script type="text/javascript">
    $(function() {
        ...
        jnsPrefix = $('#report-cpro-chatbot').DataTable({
            ...
            , "serverSide": true
            , "ajax": {
                "url": "{{ route('report.cpro.chatbot-list-data') }}"
                , "data": function(data) {
            ...
            , "columnDefs": [{
                ...
                , render: function(data, type, row) {
                    ...
                    return '<a href="' + urlDetail + '"  target="_blank"  class="edit btn btn-success text-white btn-sm ">Detail</a> '
                }
