...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">CPRO DIVISIONS</div>
                ...
                <div class="card-body">
                   ...
                   <table class="table">
                    <thead>
                        <tr>
                            <th>Division ID</th><th>Division</th><th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td>{{$user['division-id']}}</td><td>{{$user['division-name']}}</td> <td><a href="{{route('m2m.users.edit',['user'=>$user['row-num']])}}" target-modal="#m2mUserForm" class="btn btn-warning btn-sm text-white update-modal-form">Edit</a> <a href="{{route('m2m.users.delete',['user'=>$user['row-num']])}}" class="btn btn-danger btn-sm text-white ajax-delete">Delete</a> </td>
                        </tr>
                        @endforeach
