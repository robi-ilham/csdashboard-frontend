...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <Button class="btn btn-success text-white btn-modal-new-form" target-modal="#m2mForm" target-url="{{ route('jns.https.create')}}">Add New</Button>
                        </div>
                    </div>
                   <table class="table">
                    <thead>
                        <tr>
                            <th>Division</th><th>Client</th><th>APi Key</th><th>Username</th><th>Created</th><th>Modified</th><th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
  ...
  <!-- Modal -->
  <div class="modal fade" id="m2mForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
