                ...
                <div class="card-body">
                   ...
                   <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$user['division_id']}}</td><td>{{$user['client_id']}}</td>  <td>{{$user['sender_id']}}</td><td>{{$user['name']}}</td><td>{{$user['username']}}</td><td><?=$user['created'];?></td><td><?=$user['modified'];?></td><td><a href="{{route('m2m.users.edit',['user'=>$user['id']])}}" target-modal="#m2mUserForm" class="btn btn-warning btn-sm text-white update-modal-form">Edit</a> <a href="{{route('m2m.users.delete',['user'=>$user['id']])}}" class="btn btn-danger btn-sm text-white ajax-delete">Delete</a> </td>
                        </tr>
                        @endforeach
