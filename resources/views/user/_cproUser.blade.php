...
<thead class="table-dark">
    <tr>
      <th>No</th><th>Client</th><th>Fullname</th><th>Division</th><th>Privilege</th><th>Username</th><th>Sender ID</th><th>status</th><th>Action</th>
    </tr>
</thead>
<tbody>
       ...
       // "lengthMenu": [[ 5, 15, 25, 100, -1 ], [ 5, 15, 25, 100, "All" ]],
        ...
        "columns": [
          {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                  ...
                  {data: 'privilege-name', name: 'privilege-name'},
                  {data: 'username', name: 'username'},
                  {data: 'sender-id', name: 'sender-id'},
